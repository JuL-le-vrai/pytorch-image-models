...
group.add_argument('--LoRA-training', action='store_true', default=False)
group.add_argument('--head-only', action='store_true', default=False)
...
def main():
    ...
    if args.LoRA_training:
        config = LoraConfig(target_modules=r".*\.mlp\.fc\d", modules_to_save=["head"])
